      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'index.php/rack/';?>"><i class="fa fa-circle-o"></i>Manage Racks</a></li>
            <li><a href="<?php echo base_url().'index.php/book/';?>"><i class="fa fa-circle-o"></i> Manage Books</a></li>
          </ul>
        ...
        <li>
          <a href="pages/widgets.html" style="display: none;">
        ...
        <li>
          <a href="pages/calendar.html" style="display: none;">
        ...
        <li>
          <a href="pages/mailbox/mailbox.html" style="display: none;">
